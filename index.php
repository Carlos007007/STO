...
<?php
	...
	/*---------- Iniciando sesion ----------*/
    require_once "./vistas/inc/session_start.php";
    ...
    <?php
        ...
        if(isset($pagina[0]) && DASHBOARD==$pagina[0]){
            ...
            if($vistas=="login" || $vistas=="404"){
                ...
                if(!isset($_SESSION['id_sto']) || !isset($_SESSION['nombre_sto']) || !isset($_SESSION['apellido_sto']) || !isset($_SESSION['usuario_sto']) || !isset($_SESSION['cargo_sto'])){
